...
test('同日多条睡眠取最新一条，匹配分不称睡眠质量',()=>{const a=record('a','sleep',{hours:6},'2026-09-22'),b={...record('b','sleep',{hours:8}),createdAt:'2026-09-22T13:00:00'};const d=D.build('sleep','2026-09-22',[a,b]).today;assert.equal(d.value,8);assert.equal(d.scoreKind,'sleepGoal');});
